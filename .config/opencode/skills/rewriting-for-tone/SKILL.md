...
- Format code identifiers, filenames, config keys, and CLI commands in backticks with their actual casing (e.g. `CLAUDE.md` not Claude.md, `package.json`, `npm run dev`). Don't lowercase or prettify a filename that's actually all-caps on disk
